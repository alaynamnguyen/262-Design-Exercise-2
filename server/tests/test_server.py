...
# # from server.server accept_wrapper, service_connection, write_users_messages_json
# from server import accept_wrapper, service_connection, write_users_messages_json
# from model import User, Message

# class TestServer(unittest.TestCase):

#     @patch("server.server.sel")
...
#     @patch("server.server.sel")
#     @patch("server.server.parse_request")
#     @patch("server.server.send_response")
